                  ...
                  if (!href) {
                    return (
                      <TableRow key={userId}>
                        ...
                        <TableCell>—</TableCell>
                        <TableCell className="text-right tabular-nums">${spend.openai.toFixed(2)}</TableCell>
                        <TableCell className="text-right tabular-nums">${spend.apify.toFixed(2)}</TableCell>
